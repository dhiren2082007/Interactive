...
<body>
    ...
    <div style="white-space: nowrap; overflow-x: auto; padding: 1rem;">
        <div style="display: inline-block; margin-right: 10px;" onclick="openModal(this)">
            <img src="IMG-20251006-WA0005.jpg" style="height: 200px;">
        </div>
        <div style="display: inline-block; margin-right: 10px;" onclick="openModal(this)">
            <img src="IMG-20251006-WA0006.jpg" style="height: 200px;">
        </div>
        <div style="display: inline-block; margin-right: 10px;" onclick="openModal(this)">
            <img src="IMG-20251006-WA0007.jpg" style="height: 200px;">
        </div>
        <div style="display: inline-block;" onclick="openModal(this)">
            <img src="IMG-20251006-WA0008.jpg" style="height: 200px;">
        </div>
    </div>
...
## OUTPUT:
<img width="923" height="466" alt="Screenshot 2025-10-08 093212" src="https://github.com/user-attachments/assets/afe51247-b884-42ad-847b-71f02f7dbc72" />
